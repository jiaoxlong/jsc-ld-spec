...
project = u'JSON Schema LD Specification'
copyright = u'2022, IDLab, Ghent University – imec'
author = 'Jiao Long'
...
htmlhelp_basename = 'JSON Schema LD'
...
latex_documents = [
  ('index', 'JSONSchemaLD.tex', u'JSON Schema LD',
   u'Jiao Long, et al\\\\IDLab, Ghent University – imec', 'manual'),
]
...
man_pages = [
    ('index', 'JSONSchemaLD', u'JSON Schema LD',
     [u'Jiao Long, et al'], 1)
]
...
texinfo_documents = [
  ('index', 'JSONSchemaLD', u'JSON Schema LD',
   u'Jiao Long, et al', 'JSONSchemaLD',
   u'JSON Schema LD specification',
   'Miscellaneous'),
]
